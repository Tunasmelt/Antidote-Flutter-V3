...
class AuthService {
  ...
  Future<void> signInWithSpotify() async {
    try {
      ...
      // Note: This creates a Supabase session, but Spotify tokens may need to be extracted separately
      await _supabase.auth.signInWithOAuth(
        OAuthProvider.spotify,
        redirectTo: EnvConfig.spotifyRedirectUri,
        authScreenLaunchMode: LaunchMode.externalApplication,
        scopes: 'user-read-private user-read-email playlist-read-private playlist-read-collaborative user-library-read user-top-read user-read-recently-played',
      );
